...
class Config:
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            # Gct parameters
            text_file.write('# Gct parameters\n')
            text_file.write('# ****************\n\n')
            text_file.write('Gct_feature = {:s}\n'.format(self.Gct_feature))
            text_file.write('first_Gct_feature = {:s}\n\n'.format(self.first_Gct_feature))
